...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const swiper = new Swiper(".swiper-container", {
        slidesPerView: "auto", // ✅ Позволяет карточке занимать нужную ширину
        centeredSlides: false, // ✅ Отключаем центрирование, чтобы карточка не обрезалась
        spaceBetween: 0,
        loop: false,
        keyboard: {
            enabled: true,
    ...
    function updateSlideLayout() {
        ...
        slides.forEach(slide => {
            ...
            if (window.innerWidth < 768) {
                slide.style.maxWidth = "100vw"; // ✅ Карточка занимает всю ширину экрана
